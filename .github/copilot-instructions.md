...
- [x] Install Required Extensions
      ONLY install extensions mentioned by the get_project_setup_info tool. Skip this step otherwise and mark as completed.
...
- [x] Ensure Documentation is Complete
      ...
      Remove any unneeded guidance once documentation is complete.
...
- User receives clear instructions to debug/launch the project.
